  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 lg:px-10">
        <h2 className="mb-4 max-w-4xl font-display text-lg font-semibold text-black dark:text-white md:text-4xl">
          Our journey
        </h2>
        <p className="max-w-sm text-sm text-neutral-700 dark:text-neutral-300 md:text-base">
          We&apos;ve been working on here for the past 2 years. Here&apos;s a
      ...
      <div ref={ref} className="relative mx-auto max-w-7xl pb-20">
        ...
        <div className="absolute left-8 top-0 h-full w-[2px] overflow-hidden bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-0% via-neutral-200 to-transparent to-[99%] [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] dark:via-neutral-700 md:left-8">
          <motion.div
            style={{
