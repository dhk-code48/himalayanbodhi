...
function Accordion({ children, className, transition, variants }: AccordionProps) {
  return (
...
function AccordionTrigger({ children, className, onToggle, expanded }: AccordionTriggerProps) {
  return (
    <button
      onClick={onToggle}
...
function AccordionContent({ children, expanded, className }: AccordionContentProps) {
